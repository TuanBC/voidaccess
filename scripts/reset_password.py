...
Example:
    docker exec -it voidaccess-api python scripts/reset_password.py admin@example.com TempPass123!
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Reset a VoidAccess user password.")
